...
azureLoader.Name = "uh yea ik i stole the ui do i care no LOL"
...
sound:Play()
    ...
    script.Parent.Parent.Parent.LoadingText.Text = "#1 femboy lock"
...
sound:Play()
    ...
    script.Parent.Parent.Parent.LoadingText.Text = "WTF IS THAT A NIGGER!"
...
sound:Play()
    ...
    script.Parent.Parent.Parent.LoadingText.Text = "STEP BRO WHYS UR DICK IN MY ASS"
...
sound:Play()
    ...
    script.Parent.Parent.Parent.LoadingText.Text = "OMG IS KKK REAL?!"
...
local title_string = "skid.cc | User Status : "..CheckStatus(game.Players.LocalPlayer.Name).." | %A, %B"
